    ...
    function startIntroChat() {
        chat.createChatMessage("Hi", 1);
        setTimeout(function(){chat.createChatMessage("You need to get out of the building as quickly as possible", 1)}, 1500);
        setTimeout(function(){chat.createChatMessage("I could not get the password for the door, since it seems like it changes every month", 1)}, 5000);
        setTimeout(function(){chat.createChatMessage("But I found this.. it might help you to find out the password", 1)}, 10000);
        setTimeout(function(){chat.createChatMessage("the password from january was: 101142111825", 1)}, 15000);
        setTimeout(function(){chat.createChatMessage("the password from March was: 1311838", 1)}, 19000);
        setTimeout(function(){chat.createChatMessage("you need to find out the password for this month july, HURRY!", 1)}, 22000);
    }
